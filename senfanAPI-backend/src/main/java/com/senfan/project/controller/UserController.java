...
import com.senfan.project.model.dto.user.*;
import com.senfan.project.model.vo.UserVO;
import com.senfan.project.service.UserService;
import com.senfan.senfanapicommon.common.BaseResponse;
import com.senfan.senfanapicommon.common.DeleteRequest;
...
public class UserController {
    ...
    public BaseResponse<Map> getUserKey(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        String userAccount = userLoginRequest.getUserAccount();
        String userPassword = userLoginRequest.getUserPassword();
        if (StringUtils.isAnyBlank(userAccount,userPassword)){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Map<String,String> res = userService.getUserKey(userAccount,userPassword, request);
    ...
    public BaseResponse<Boolean> updateUserKey(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        String userAccount = userLoginRequest.getUserAccount();
        String userPassword = userLoginRequest.getUserPassword();
        if (StringUtils.isAnyBlank(userAccount,userPassword)){
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        Boolean res = userService.updateUserKey(userAccount,userPassword,request);
        return ResultUtils.success(res);
    }
    /**
     * 根据 id 获取用户
